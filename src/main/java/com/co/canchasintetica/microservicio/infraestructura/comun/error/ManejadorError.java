package com.co.canchasintetica.microservicio.infraestructura.comun.error;
...
import com.co.canchasintetica.microservicio.dominio.excepcion.ValorAbonoExcepcion;
...
public class ManejadorError  extends ResponseEntityExceptionHandler {
	    ...
	    public ManejadorError() {
	        CODIGOS_ESTADO.put(CamposVaciosExcepcion.class.getSimpleName(), HttpStatus.BAD_REQUEST.value());
	        CODIGOS_ESTADO.put(ReservaUnicaExcepcion.class.getSimpleName(), HttpStatus.BAD_REQUEST.value());
	        CODIGOS_ESTADO.put(ValidarFinalizarReservaExcepcion.class.getSimpleName(), HttpStatus.NOT_FOUND.value());
	        CODIGOS_ESTADO.put(ValorAbonoExcepcion.class.getSimpleName(), HttpStatus.BAD_REQUEST.value());
